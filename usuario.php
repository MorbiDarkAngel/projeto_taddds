...
<table >
  ...
  <tr>
   ...
   <tr>
    <td>Tipo:</td>
    <td><input type="radio" name="tipo" value="ADMIN" <?php  include('verifica.php'); echo (@$_POST['tipo'] == "ADMIN" ? "" : "" );?> > Administrador

    <input type="radio" name="tipo" value="USER" <?php echo (@$_POST['tipo'] == "USER" ? " checked" : "" );?> > Usuário comum   
    </td>
  </tr>
	<td>
